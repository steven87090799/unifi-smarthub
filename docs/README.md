...
| 目前架構 | [ARCHITECTURE.md](ARCHITECTURE.md) |
| 後端定位 | [SERVER-MAP.md](../SERVER-MAP.md) |
| 前端定位 | [FRONTEND-MAP.md](../FRONTEND-MAP.md) |
...
權威順序：實際 source／tests → `SERVER-MAP.md`／`FRONTEND-MAP.md` → 專題文件。報告只代表其記錄日期與 commit，不取代目前程式。
